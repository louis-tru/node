  ...
  function startup() {
    ...
    if (NativeModule.exists('_third_party_main')) {
      ...
      if (process._eval != null && !process._forceRepl) {
        ...
        process.argv[1] = _pkgutil.resolveMainPath(process.argv[1]);
        ...
        if (process._syntax_check_only != null) {
          ...
          // read the source
          const filename = process.argv[1]; // Module._resolveFilename(process.argv[1]);
          var source = _pkgutil.readFileSync(filename, 'utf-8');
